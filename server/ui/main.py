...
class Window(QMainWindow):
    ...
    def configure(self):
        ...
        line_1 = folium.vector_layers.PolyLine(coords_1, popup='<b>Path of Vehicle_1</b>', tooltip='Vehicle_1',
                                               color='blue', weight=10).add_to(m)
        line_2 = folium.vector_layers.PolyLine(coords_2, popup='<b>Path of Vehicle_2</b>', tooltip='Vehicle_2',
                                               color='red', weight=10).add_to(m)
        line_3 = folium.vector_layers.PolyLine(coords_3, popup='<b>Path of Vehicle_3</b>', tooltip='Vehicle_3',
                                               color='green', weight=10).add_to(m)

        folium.Marker(location=[28.695800, 77.244721], popup='Default popup Marker1', tooltip='Click here to see Popup',
                      icon=folium.Icon(color='red', icon='home')).add_to(m)
        folium.Marker(location=[28.645800, 77.214721], popup='<strong>Marker3</strong>',
                      tooltip='<strong>Click here to see Popup</strong>').add_to(m)
        folium.Marker(location=[28.655800, 77.274721], popup='<h3 style="color:green;">Marker2</h3>',
                      tooltip='<strong>Click here to see Popup</strong>').add_to(m)

        folium.Marker(location=[28.4211091, 77.0267361], popup='Custom Marker 1', tooltip='Click here to see Popup',
        ...
        #avionicsLayout = QVBoxLayout()
        #self.bottomLayout.addLayout(avionicsLayout)
